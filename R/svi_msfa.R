#' Stochastic Variational Inference for Bayesian Multi-Study Factor Analysis
#'
...
#'
#' @param X_s List of length \eqn{S}{S}, corresponding to number of different studies to be analyzed.
...
#' @param fr Forgetting rate used in the SVI step size schedule. Default is 0.51. See Hoffman et al. (2013) for more details.
#' @param delay Delay parameter used in the SVI step size schedule. Default is 10. See Hoffman et al. (2013) for more details.
#' @param batch_prop Proportion of data to be sampled during each iteration of SVI. Default is 0.2.
...
#' @references Hoffman, M. D. (2013). Stochastic Variational Inference. Journal of Machine Learning Research, 14, 1303–1347.
